...
public class MySqlEmployeeController {
	...
	@Autowired
	private MySqlEmployeeService mySqlEmployeService;

	// Create a new employee
	@PostMapping("employee")
	public ResponseEntity<Employee> createEmployee(@RequestBody Employee employee) {
		Employee savedEmployee = mySqlEmployeService.createEmployee(employee);
	...
	public ResponseEntity<Employee> getEmployeeById(@PathVariable Long id) {
		Optional<Employee> employee = mySqlEmployeService.getEmployeeById(id);
